    ...
    <div className="space-y-3">
      ...
      `}>
        <input
          ...
          disabled={disabled}
          className={`
            w-full bg-transparent px-3 sm:px-4 py-5 sm:py-4 text-xl sm:text-2xl font-semibold text-white placeholder-neutral-400
        ...
        {token && value && !isNaN(parseFloat(value)) && (
          <div className="absolute right-4 bottom-1 text-xs font-medium text-neutral-400 bg-neutral-800 rounded">
            {formatUsdValue()}
          </div>
        )}
      </div>
